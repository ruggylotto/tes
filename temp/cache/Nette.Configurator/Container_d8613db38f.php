<?php
// source: C:\Program Files (x86)\Ampps\www\tes\app/config/config.neon 
// source: C:\Program Files (x86)\Ampps\www\tes\app/config/config.local.neon 

class Container_d8613db38f extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			'appDir' => 'C:\Program Files (x86)\Ampps\www\tes\app',
			'wwwDir' => 'C:\Program Files (x86)\Ampps\www\tes\www',
			'debugMode' => true,
			'productionMode' => false,
			'consoleMode' => false,
			'tempDir' => 'C:\Program Files (x86)\Ampps\www\tes\app/../temp',
		];
	}
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, 'C:\Program Files (x86)\Ampps\www\tes\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\SQLiteJournal('C:\Program Files (x86)\Ampps\www\tes\app/../temp/cache/journal.s3db');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('C:\Program Files (x86)\Ampps\www\tes\app/../temp/cache',
	...
	{
		return new Container_d8613db38f_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
...
class Container_d8613db38f_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_d8613db38f $container)
	{
	...
	public function create()
	{
		...
		$service->setTempDirectory('C:\Program Files (x86)\Ampps\www\tes\app/../temp/cache/latte');
